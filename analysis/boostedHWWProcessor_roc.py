...
class BoostedHWWProcessorROC(processor.ProcessorABC):
...
if __name__ == '__main__':
    ...
    processor_instance = BoostedHWWProcessorROC(corrections=corrections,
                                                debug=args.debug,
                                                year=args.year,
                                                )

    save(processor_instance, 'boostedHWWProcessor_roc.coffea')
