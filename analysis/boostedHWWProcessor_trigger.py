...
class BoostedHWWProcessorTrigger(processor.ProcessorABC):
...
if __name__ == '__main__':
    ...
    processor_instance = BoostedHWWProcessorTrigger(corrections=corrections,
                                                   debug=args.debug,
                                                   year=args.year,
                                                   )

    save(processor_instance, 'boostedHWWProcessor_trigger.coffea')
