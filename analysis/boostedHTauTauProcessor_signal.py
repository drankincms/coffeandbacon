...
class BoostedHTauTauProcessor(processor.ProcessorABC):
...
if __name__ == '__main__':
    ...
    processor_instance = BoostedHTauTauProcessor(corrections=corrections,
                                             debug=args.debug,
                                             year=args.year,
                                             )

    save(processor_instance, 'boostedHTauTauProcessor_signal.coffea')
