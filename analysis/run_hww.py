...
if __name__ == '__main__':
    ...
    parser.add_argument('--processor', default='boostedHWWProcessor.coffea', help='The name of the compiled processor file (default: %(default)s)')
    parser.add_argument('--output', default=r'hists_{sample}.coffea', help='Output histogram filename (default: %(default)s)')
    parser.add_argument('--samplejson', default='metadata/hww_files.json', help='JSON file containing dataset and file locations (default: %(default)s)')
