...
# PreSel for hadronic and semi-leptonic HTauTau
...
class BoostedHTauTauProcessorPreSel(processor.ProcessorABC):
...
if __name__ == '__main__':
    ...
    processor_instance = BoostedHTauTauProcessorPreSel(corrections=corrections,
                                                   debug=args.debug,
                                                   year=args.year,
                                                   )

    save(processor_instance, 'boostedHTauTauProcessor_presel.coffea')
